...
function getNextSibling$1(node) {
  return node
    ? node.type === Fragment
      ? node.anchor
      : node.el
...
function patchChildren(
  ...
  while (s1 <= e1 && s2 <= e2) {
    ...
    if (sNode1 === null) {
      ...
      insertElement(eNode2.el, container, getNextSibling$1(eNode1));
      s1++;
      e2--;
...
function mountFragment(context) {
  ...
  node.anchor = getNextSibling$1(node.children.at(-1));
}
...
exports._jsx = _jsx;
exports._node_flag = _node_flag;
exports.callWithErrorHandler = callWithErrorHandler;
exports.defineElement = defineElement;
exports.getCurrentInstance = getCurrentInstance;
exports.hydrateChildren = hydrateChildren;
exports.hydrateProps = hydrateProps;
exports.ignoreElement = ignoreElement;
